...
export const updateOrder = asyncHandler(async (req, res) => {
    ...
    const orderData = req.body;
    const updatedOrder = await orderService.updateOrder(orderId, orderData, req.user);
    return res.status(200).json(new ApiResponse(200, { order: updatedOrder }, "Order updated successfully"));
});
...
export const deleteOrder = asyncHandler(async (req, res) => {
    ...
    await orderService.deleteOrder(orderId, req.user);
