...
export const createRider = asyncHandler(async (req, res) => {
    ...
    const rider = await riderService.createRider({
        ...
        availability: body.availability === 'AVAILABLE' || body.availability === 'DISPATCHED' || body.availability === 'OFFLINE'
            ? body.availability
            : undefined,
        accountStatus: body.accountStatus === 'ACTIVE' || body.accountStatus === 'INACTIVE' || body.accountStatus === 'BLOCKED'
            ? body.accountStatus
            : undefined,
    });
