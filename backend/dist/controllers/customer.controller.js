...
export const validateVoucher = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, voucher, 'Voucher validated successfully'));
});
export const getFavourites = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, favourites, 'Favourites fetched successfully'));
});
export const toggleFavourite = asyncHandler(async (req, res) => {
    ...
    const result = await customerService.toggleFavourite(userId, productId);
...
export const updateAddress = asyncHandler(async (req, res) => {
    ...
    if (!userId)
        throw new ApiError(401, 'Unauthorized');
    const address = await customerService.updateAddress(userId, id, req.body);
...
export const updateSecuritySettings = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, settings, 'Security settings updated successfully'));
});
...
export const requestDataExport = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, result, 'Data export requested successfully'));
});
export const clearHistory = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, result, 'History cleared successfully'));
});
...
export const revokeSession = asyncHandler(async (req, res) => {
    ...
    if (!userId)
        throw new ApiError(401, 'Unauthorized');
    await customerService.revokeSession(userId, id);
...
export const updatePushToken = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, result, 'Push token updated successfully'));
});
...
export const markNotificationRead = asyncHandler(async (req, res) => {
    ...
    if (!userId)
        throw new ApiError(401, 'Unauthorized');
    const result = await customerService.markNotificationRead(userId, req.params.id);
...
export const getPaymentMethods = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, paymentMethods, 'Payment methods fetched successfully'));
});
export const addPaymentMethod = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, paymentMethod, 'Payment method added successfully'));
});
export const setDefaultPaymentMethod = asyncHandler(async (req, res) => {
    ...
    if (!userId)
        throw new ApiError(401, 'Unauthorized');
    const paymentMethod = await customerService.setDefaultPaymentMethod(userId, id);
    return res.status(200).json(new ApiResponse(200, paymentMethod, 'Payment method set as default'));
});
export const deletePaymentMethod = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, {}, 'Payment method deleted successfully'));
});
...
export const updateCustomerForAdmin = asyncHandler(async (req, res) => {
    const updatedCustomer = await customerService.updateCustomerForAdmin(req.params.id, req.body);
...
export const deleteCustomerForAdmin = asyncHandler(async (req, res) => {
    await customerService.deleteCustomerForAdmin(req.params.id, req.user);
