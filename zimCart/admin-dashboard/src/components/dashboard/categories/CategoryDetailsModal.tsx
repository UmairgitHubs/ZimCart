        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-6 pt-6 border-t border-slate-50">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Global Link</p>
                  <button className="text-xs font-bold text-emerald-600 flex items-center gap-1.5 hover:underline">
                    <Globe className="w-3.5 h-3.5" /> zimcart.com/{category.slug}
                  </button>
                </div>
             </div>
