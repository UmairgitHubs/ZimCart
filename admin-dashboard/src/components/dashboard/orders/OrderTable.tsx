...
export function OrderTable({ orders, onViewDetails, onEdit, onDelete, isLoading }: OrderTableProps) {
          ...
          <tbody>
            {orders.map((order) => (
              ...
              >
                ...
                <td className="px-8 py-5">
                  <div className="flex flex-col">
                    <span className="text-sm font-extrabold text-slate-800">Rs {order.totalAmount.toLocaleString()}</span>
          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-50">
              <div>
                ...
                <p className="text-base font-black text-slate-800">Rs {order.totalAmount.toLocaleString()}</p>
              </div>
            ...
            <div className="flex items-center gap-3 mt-8">
              ...
              <button 
                onClick={async () => {
                  ...
                  setIsDeleting(true);
                  try {
                    await onDelete(orderToDelete.dbId);
                  } finally {
                    setIsDeleting(false);
