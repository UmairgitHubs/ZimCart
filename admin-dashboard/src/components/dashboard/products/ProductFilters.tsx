...
export function ProductFilters({
  ...
  // Sync Parent only when debounced value changes AND is different from current
  useEffect(() => {
  ...
  return (
    <div className="bg-white rounded-[24px] border border-slate-100 mb-6 p-4 md:p-6 shadow-sm">
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                ...
                isCategoryOpen ? "border-emerald-500 text-emerald-600 ring-4 ring-emerald-50 shadow-lg shadow-emerald-500/5" : "border-slate-100 text-slate-600 hover:border-slate-200"
              )}
            >
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                ...
                isStatusOpen ? "border-emerald-500 text-emerald-600 ring-4 ring-emerald-50 shadow-lg shadow-emerald-500/5" : "border-slate-100 text-slate-600 hover:border-slate-200"
              )}
            >
              <div className="flex items-center gap-2">
